...
class FrameDispatcher extends _dispatcher.Dispatcher {
  ...
  constructor(scope, frame) {
    ...
    (0, _utils.debugAssert)(
      frame._page.mainFrame(),
      "Cannot determine whether the frame is a main frame",
    );
  ...
  async evaluateExpressionHandle(params, metadata) {
    return {
      handle: _elementHandlerDispatcher.ElementHandleDispatcher.fromJSHandle(
        this,
        await this._frame.evaluateExpressionHandle(
          params.expression,
          {
            isFunction: params.isFunction,
          },
  ...
  async evalOnSelector(params, metadata) {
    return {
      value: (0, _jsHandleDispatcher.serializeResult)(
        await this._frame.evalOnSelector(
          params.selector,
          !!params.strict,
          params.expression,
          params.isFunction,
  ...
  async querySelectorAll(params, metadata) {
    ...
    return {
      elements: elements.map((e) =>
        _elementHandlerDispatcher.ElementHandleDispatcher.from(this, e),
      ),
    };
  }
