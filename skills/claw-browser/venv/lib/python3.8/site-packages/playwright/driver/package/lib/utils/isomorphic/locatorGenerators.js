...
exports.PythonLocatorFactory =
  exports.JsonlLocatorFactory =
  exports.JavaScriptLocatorFactory =
  exports.JavaLocatorFactory =
  exports.CSharpLocatorFactory =
    void 0;
...
function asLocators(lang, selector, isFrameLocator = false, maxOutputSize = 20, preferredQuote) {
  try {
    return innerAsLocators(
      ...
      (0, _selectorParser.parseSelector)(selector),
      isFrameLocator,
      maxOutputSize,
    );
  } catch (e) {
...
function innerAsLocators(factory, parsed, isFrameLocator = false, maxOutputSize = 20) {
  ...
  for (let index = 0; index < parts.length; index++) {
    ...
    if (part.name === "internal:text") {
      ...
      tokens.push([
        factory.generateLocator(base, "text", text, {
          exact,
        }),
      ]);
      continue;
    ...
    if (part.name === "internal:has-text") {
      ...
      if (!exact) {
        tokens.push([
          factory.generateLocator(base, "has-text", text, {
            exact,
          }),
        ]);
        continue;
    ...
    if (part.name === "internal:has-not-text") {
      ...
      if (!exact) {
        tokens.push([
          factory.generateLocator(base, "has-not-text", text, {
            exact,
          }),
        ]);
        continue;
    ...
    if (part.name === "internal:label") {
      const { exact, text } = detectExact(part.body);
      tokens.push([
        factory.generateLocator(base, "label", text, {
          exact,
        }),
      ]);
      continue;
    ...
    if (part.name === "internal:attr") {
      ...
      if (name === "placeholder") {
        tokens.push([
          factory.generateLocator(base, "placeholder", text, {
            exact,
          }),
        ]);
        continue;
      ...
      if (name === "alt") {
        tokens.push([
          factory.generateLocator(base, "alt", text, {
            exact,
          }),
        ]);
        continue;
      ...
      if (name === "title") {
        tokens.push([
          factory.generateLocator(base, "title", text, {
            exact,
          }),
        ]);
        continue;
...
class JavaScriptLocatorFactory {
  ...
  quote(text) {
    ...
    return (0, _stringUtils.escapeWithQuotes)(
      text,
      (_this$preferredQuote = this.preferredQuote) !== null && _this$preferredQuote !== void 0
        ? _this$preferredQuote
        : "'",
    );
  }
}
  ...
  generateLocator(base, kind, body, options = {}) {
    ...
    switch (kind) {
      ...
      case "role":
        ...
        for (const { name, value } of options.attrs)
          attrs.push(
            `.set${(0, _stringUtils.toTitleCase)(name)}(${typeof value === "string" ? this.quote(value) : value})`,
          );
  ...
  generateLocator(base, kind, body, options = {}) {
    switch (kind) {
      ...
      case "role":
        ...
        for (const { name, value } of options.attrs)
          attrs.push(
            `${(0, _stringUtils.toTitleCase)(name)} = ${typeof value === "string" ? this.quote(value) : value}`,
          );
