...
async function connectBidiOverCdp(cdp) {
  ...
  const cdpConnection = new bidiCdpConnection.MapperCdpConnection(
    cdpTransportImpl,
    bidiServerLogger,
  );
  ...
  cdp.onclose = () => {
    ...
    return (_bidiConnection$onclo = bidiConnection.onclose) === null ||
      _bidiConnection$onclo === void 0
      ? void 0
      : _bidiConnection$onclo.call(bidiConnection);
  };
...
class BidiTransportImpl {
  ...
  sendMessage(message) {
    ...
    return (_this$_bidiConnection = (_this$_bidiConnection2 = this._bidiConnection).onmessage) ===
      null || _this$_bidiConnection === void 0
      ? void 0
      : _this$_bidiConnection.call(_this$_bidiConnection2, message);
  }
  close() {
    var _this$_bidiConnection3, _this$_bidiConnection4;
    (_this$_bidiConnection3 = (_this$_bidiConnection4 = this._bidiConnection).onclose) === null ||
      _this$_bidiConnection3 === void 0 ||
      _this$_bidiConnection3.call(_this$_bidiConnection4);
  }
}
class BidiConnection {
  ...
  send(s) {
    ...
    (_this$_bidiTransport$ = (_this$_bidiTransport = this._bidiTransport)._handler) === null ||
      _this$_bidiTransport$ === void 0 ||
      _this$_bidiTransport$.call(_this$_bidiTransport, s);
  }
  close() {
    this._closeCallback();
  }
...
class CdpTransportImpl {
  constructor(connection) {
    ...
    this._connection.onmessage = (message) => {
      var _this$_handler;
      (_this$_handler = this._handler) === null ||
        _this$_handler === void 0 ||
        _this$_handler.call(this, JSON.stringify(message));
    };
  }
  setOnMessage(handler) {
    this._handler = handler;
