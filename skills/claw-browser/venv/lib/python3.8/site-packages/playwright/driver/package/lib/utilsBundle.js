...
function parseStackTraceLine(line) {
  ...
  if (
    !process.env.PWDEBUGIMPL &&
    (((_frame$file = frame.file) !== null &&
      _frame$file !== void 0 &&
      _frame$file.startsWith("internal")) ||
      ((_frame$file2 = frame.file) !== null &&
        _frame$file2 !== void 0 &&
        _frame$file2.startsWith("node:")))
  )
    return null;
  ...
  const file = frame.file.startsWith("file://")
    ? _url.default.fileURLToPath(frame.file)
    : _path.default.resolve(process.cwd(), frame.file);
  return {
    file,
    line: frame.line || 0,
