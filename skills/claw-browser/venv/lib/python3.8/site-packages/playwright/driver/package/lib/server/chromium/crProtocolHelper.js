...
function exceptionToError(exceptionDetails) {
  ...
  err.stack = stack;
  const nameOverride =
    (_exceptionDetails$exc = exceptionDetails.exception) === null ||
    _exceptionDetails$exc === void 0 ||
    (_exceptionDetails$exc = _exceptionDetails$exc.preview) === null ||
    _exceptionDetails$exc === void 0
      ? void 0
      : _exceptionDetails$exc.properties.find((o) => o.name === "name");
  err.name = nameOverride
    ? (_nameOverride$value = nameOverride.value) !== null && _nameOverride$value !== void 0
      ? _nameOverride$value
      : "Error"
    : name;
  return err;
