...
function calculatePlatform() {
  ...
  if (platform === "linux") {
    ...
    if (
      (distroInfo === null || distroInfo === void 0 ? void 0 : distroInfo.id) === "ubuntu" ||
      (distroInfo === null || distroInfo === void 0 ? void 0 : distroInfo.id) === "pop" ||
      (distroInfo === null || distroInfo === void 0 ? void 0 : distroInfo.id) === "neon" ||
      (distroInfo === null || distroInfo === void 0 ? void 0 : distroInfo.id) === "tuxedo"
    ) {
      const isOfficiallySupportedPlatform =
        (distroInfo === null || distroInfo === void 0 ? void 0 : distroInfo.id) === "ubuntu";
    ...
    if (
      (distroInfo === null || distroInfo === void 0 ? void 0 : distroInfo.id) === "debian" ||
      (distroInfo === null || distroInfo === void 0 ? void 0 : distroInfo.id) === "raspbian"
    ) {
      const isOfficiallySupportedPlatform =
        (distroInfo === null || distroInfo === void 0 ? void 0 : distroInfo.id) === "debian";
      if ((distroInfo === null || distroInfo === void 0 ? void 0 : distroInfo.version) === "11")
        return {
          hostPlatform: "debian11" + archSuffix,
          isOfficiallySupportedPlatform,
        };
      if ((distroInfo === null || distroInfo === void 0 ? void 0 : distroInfo.version) === "12")
        return {
      ...
      if ((distroInfo === null || distroInfo === void 0 ? void 0 : distroInfo.version) === "")
        return {
          hostPlatform: "debian12" + archSuffix,
          isOfficiallySupportedPlatform,
        };
