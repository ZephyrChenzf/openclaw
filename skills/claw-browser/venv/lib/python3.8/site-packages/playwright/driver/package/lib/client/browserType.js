...
class BrowserType extends _channelOwner.ChannelOwner {
  ...
  async launch(options = {}) {
    ...
    const logger =
      options.logger ||
      ((_this$_defaultLaunchO = this._defaultLaunchOptions) === null ||
      _this$_defaultLaunchO === void 0
        ? void 0
        : _this$_defaultLaunchO.logger);
    options = {
  ...
  async launchPersistentContext(userDataDir, options = {}) {
    ...
    const logger =
      options.logger ||
      ((_this$_defaultLaunchO2 = this._defaultLaunchOptions) === null ||
      _this$_defaultLaunchO2 === void 0
        ? void 0
        : _this$_defaultLaunchO2.logger);
    (0, _utils.assert)(!options.port, "Cannot specify a port without launching as a server.");
    options = {
      ...this._defaultLaunchOptions,
  ...
  async _connect(params) {
    ...
    return await this._wrapApiCall(async () => {
      ...
      const onPipeClosed = (reason) => {
        ...
        for (const context of ((_browser = browser) === null || _browser === void 0
          ? void 0
          : _browser.contexts()) || []) {
          var _browser;
        ...
        setTimeout(() => {
          var _browser2;
          return (_browser2 = browser) === null || _browser2 === void 0
            ? void 0
            : _browser2._didClose();
        }, 0);
      };
      ...
      const result = await (0, _timeoutRunner.raceAgainstDeadline)(async () => {
        ...
        browser.on(_events.Events.Browser.Disconnected, () =>
          this._wrapApiCall(() => closePipe(), /* isInternal */ true),
        );
        return browser;
      }, deadline);
      if (!result.timedOut) {
