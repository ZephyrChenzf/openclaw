...
class AndroidDeviceDispatcher extends _dispatcher.Dispatcher {
  ...
  constructor(scope, device) {
    ...
    this.addObjectListener(_android.AndroidDevice.Events.WebViewAdded, (webView) =>
      this._dispatchEvent("webViewAdded", {
        webView,
      }),
    );
    this.addObjectListener(_android.AndroidDevice.Events.WebViewRemoved, (socketName) =>
      this._dispatchEvent("webViewRemoved", {
        socketName,
      }),
    );
    this.addObjectListener(_android.AndroidDevice.Events.Close, (socketName) =>
  ...
  async connectToWebView(params) {
    return {
      context: new _browserContextDispatcher.BrowserContextDispatcher(
        this,
        await this._object.connectToWebView(params.socketName),
      ),
    };
  }
}
...
class AndroidSocketDispatcher extends _dispatcher.Dispatcher {
  constructor(scope, socket) {
    ...
    this.addObjectListener("data", (data) =>
