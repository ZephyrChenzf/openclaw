...
function normalizeWhiteSpace(text) {
  ...
  let result =
    (_normalizedWhitespace = normalizedWhitespaceCache) === null || _normalizedWhitespace === void 0
      ? void 0
      : _normalizedWhitespace.get(text);
  if (result === undefined) {
    ...
    result = text
      ...
      .trim()
      .replace(/\s+/g, " ");
    (_normalizedWhitespace2 = normalizedWhitespaceCache) === null ||
      _normalizedWhitespace2 === void 0 ||
      _normalizedWhitespace2.set(text, result);
  }
  return result;
}
