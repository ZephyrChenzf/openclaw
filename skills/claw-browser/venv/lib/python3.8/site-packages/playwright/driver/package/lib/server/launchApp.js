...
async function launchApp(browserType, options) {
  ...
  const args = [
    ...((_options$persistentCo =
      (_options$persistentCo2 = options.persistentContextOptions) === null ||
      _options$persistentCo2 === void 0
        ? void 0
        : _options$persistentCo2.args) !== null && _options$persistentCo !== void 0
      ? _options$persistentCo
      : []),
  ];
  ...
  const context = await browserType.launchPersistentContext(
    ...
    {
      channel: !(
        (_options$persistentCo3 = options.persistentContextOptions) !== null &&
        _options$persistentCo3 !== void 0 &&
        _options$persistentCo3.executablePath
      )
        ? (0, _registry.findChromiumChannel)(options.sdkLanguage)
        : undefined,
...
async function syncLocalStorageWithSettings(page, appName) {
  ...
  const settingsFile = _path.default.join(
    _registry.registryDirectory,
    ".settings",
    `${appName}.json`,
  );
