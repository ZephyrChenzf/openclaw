    ...
    switch (name.toLowerCase()) {
      case "expires":
        ...
        if (isFinite(expiresMs)) {
          ...
          else cookie.expires = Math.min(expiresMs / 1000, _network.kMaxCookieExpiresDateInSeconds);
        }
        break;
      case "max-age":
        ...
        if (isFinite(maxAgeSec)) {
          ...
          if (maxAgeSec <= 0) cookie.expires = 0;
            ...
            cookie.expires = Math.min(
              Date.now() / 1000 + maxAgeSec,
              _network.kMaxCookieExpiresDateInSeconds,
            );
        }
        break;
      case "domain":
