...
class BidiBrowser extends _browser.Browser {
  ...
  constructor(parent, transport, options) {
    ...
    this._connection = new _bidiConnection.BidiConnection(
      transport,
    ...
    this._eventListeners = [
      _eventsHelper.eventsHelper.addEventListener(
        ...
        this._onBrowsingContextCreated.bind(this),
      ),
      _eventsHelper.eventsHelper.addEventListener(
        this._browserSession,
        "script.realmDestroyed",
        this._onScriptRealmDestroyed.bind(this),
      ),
    ];
  }
  _onDisconnect() {
...
class BidiBrowserContext extends _browserContext.BrowserContext {
  ...
  _bidiPages() {
    return [...this._browser._bidiPages.values()].filter(
      (bidiPage) => bidiPage._browserContext === this,
    );
  }
  pages() {
    return this._bidiPages()
      .map((bidiPage) => bidiPage._initializedPage)
      .filter(Boolean);
  }
