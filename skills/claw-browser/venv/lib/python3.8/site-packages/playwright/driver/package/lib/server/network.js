...
class Request extends _instrumentation.SdkObject {
  constructor(
    ...
    this._isFavicon =
      ...
      !!(redirectedFrom !== null && redirectedFrom !== void 0 && redirectedFrom._isFavicon);
  }
  ...
  _updateHeadersMap() {
    for (const { name, value } of this.headers()) this._headersMap.set(name.toLowerCase(), value);
  }
  _hasOverrides() {
  ...
  url() {
    ...
    return (
      ((_this$_overrides = this._overrides) === null || _this$_overrides === void 0
        ? void 0
        : _this$_overrides.url) || this._url
    );
  }
  resourceType() {
  ...
  method() {
    ...
    return (
      ((_this$_overrides2 = this._overrides) === null || _this$_overrides2 === void 0
        ? void 0
        : _this$_overrides2.method) || this._method
    );
  }
  postDataBuffer() {
    var _this$_overrides3;
    return (
      ((_this$_overrides3 = this._overrides) === null || _this$_overrides3 === void 0
        ? void 0
        : _this$_overrides3.postData) || this._postData
    );
  }
  headers() {
    var _this$_overrides4;
    return (
      ((_this$_overrides4 = this._overrides) === null || _this$_overrides4 === void 0
        ? void 0
        : _this$_overrides4.headers) || this._headers
    );
  }
  headerValue(name) {
  ...
  async rawRequestHeaders() {
    ...
    return (
      ((_this$_overrides5 = this._overrides) === null || _this$_overrides5 === void 0
        ? void 0
        : _this$_overrides5.headers) || this._rawRequestHeadersPromise
    );
  }
  response() {
  ...
  bodySize() {
    ...
    return (
      this._bodySize ||
      ((_this$postDataBuffer = this.postDataBuffer()) === null || _this$postDataBuffer === void 0
        ? void 0
        : _this$postDataBuffer.length) ||
      0
    );
  }
...
class Route extends _instrumentation.SdkObject {
  ...
  async redirectNavigationRequest(url) {
    ...
    this._request
      .frame()
      .redirectNavigation(url, this._request._documentId, this._request.headerValue("referer"));
  }
  async fulfill(overrides) {
    ...
    if (body === undefined) {
      if (overrides.fetchResponseUid) {
        const buffer =
          this._request._context.fetchRequest.fetchResponses.get(overrides.fetchResponseUid) ||
          _fetch.APIRequestContext.findResponseBody(overrides.fetchResponseUid);
...
class Response extends _instrumentation.SdkObject {
  ...
  async sizes() {
    ...
    if (encodedBodySize === null) {
      ...
      const headers = await this._rawResponseHeadersPromise;
      const contentLength =
        (_headers$find = headers.find((h) => h.name.toLowerCase() === "content-length")) === null ||
        _headers$find === void 0
          ? void 0
          : _headers$find.value;
