...
class Connection extends _events.EventEmitter {
  ...
  async sendMessageToServer(object, method, params, apiName, frames, stepId) {
    ...
    if (this._tracingCount && frames && type !== "LocalUtils")
      (_this$_localUtils = this._localUtils) === null ||
        _this$_localUtils === void 0 ||
        _this$_localUtils._channel
    ...
    if (id) {
      ...
      if (error && !result) {
        ...
        (0, _utils.rewriteErrorMessage)(
          parsedError,
          parsedError.message + (0, _utils.formatCallLog)(log),
        );
