...
class Frame extends _channelOwner.ChannelOwner {
  ...
  _setupNavigationWaiter(options) {
    ...
    waiter.rejectOnEvent(this._page, _events2.Events.Page.Close, () =>
  ...
  async _queryCount(selector) {
    return (
      await this._channel.queryCount({
        selector,
      })
    ).value;
  }
  ...
  async addScriptTag(options = {}) {
    ...
    return _elementHandle.ElementHandle.from(
      (
        await this._channel.addScriptTag({
          ...copy,
        })
      ).element,
    );
  ...
  async addStyleTag(options = {}) {
    ...
    return _elementHandle.ElementHandle.from(
      (
        await this._channel.addStyleTag({
          ...copy,
        })
      ).element,
    );
  ...
  getByTestId(testId) {
    return this.locator(
      (0, _locatorUtils.getByTestIdSelector)((0, _locator.testIdAttributeName)(), testId),
    );
  }
  ...
  async textContent(selector, options = {}) {
    const value = (
      await this._channel.textContent({
        selector,
        ...options,
      })
    ).value;
  ...
  async inputValue(selector, options = {}) {
    return (
      await this._channel.inputValue({
        selector,
        ...options,
      })
    ).value;
  ...
  async isDisabled(selector, options = {}) {
    return (
      await this._channel.isDisabled({
        selector,
        ...options,
      })
    ).value;
  ...
  async isEditable(selector, options = {}) {
    return (
      await this._channel.isEditable({
        selector,
        ...options,
      })
    ).value;
