...
class RecorderApp extends _events.EventEmitter {
            ...
            headers: [
              {
                name: "Content-Type",
                value:
                  _utilsBundle.mime.getType(_path.default.extname(file)) ||
  ...
  static async _open(recorder, inspectedContext) {
    ...
    const { context, page } = await (0, _launchApp.launchApp)(recorderPlaywright.chromium, {
      sdkLanguage,
      windowSize: {
        width: 600,
        height: 600,
  ...
  async setSelector(selector, userGesture) {
    if (userGesture) {
      var _this$_recorder;
      if (
        ((_this$_recorder = this._recorder) === null || _this$_recorder === void 0
          ? void 0
          : _this$_recorder.mode()) === "inspecting"
      ) {
        this._recorder.setMode("standby");
        this._page.bringToFront();
      } else {
        var _this$_recorder2;
        (_this$_recorder2 = this._recorder) === null ||
          _this$_recorder2 === void 0 ||
          _this$_recorder2.setMode("recording");
      }
    }
    await this._page
      .mainFrame()
