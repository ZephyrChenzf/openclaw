...
exports.WebSocketDispatcher =
  ...
  exports.APIRequestContextDispatcher =
    void 0;
...
class WebSocketDispatcher extends _dispatcher.Dispatcher {
  constructor(scope, webSocket) {
    ...
    this.addObjectListener(_network.WebSocket.Events.FrameSent, (event) =>
      this._dispatchEvent("frameSent", event),
    );
    this.addObjectListener(_network.WebSocket.Events.FrameReceived, (event) =>
      this._dispatchEvent("frameReceived", event),
    );
    this.addObjectListener(_network.WebSocket.Events.SocketError, (error) =>
