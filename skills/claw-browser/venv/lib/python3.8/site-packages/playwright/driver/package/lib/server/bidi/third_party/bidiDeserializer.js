...
class BidiDeserializer {
  static deserialize(result) {
    ...
    switch (result.type) {
      case "array":
        return (_result$value = result.value) === null || _result$value === void 0
          ? void 0
          : _result$value.map((value) => {
              return BidiDeserializer.deserialize(value);
            });
      case "set":
        return (_result$value2 = result.value) === null || _result$value2 === void 0
          ? void 0
          : _result$value2.reduce((acc, value) => {
              return acc.add(BidiDeserializer.deserialize(value));
            }, new Set());
      case "object":
        return (_result$value3 = result.value) === null || _result$value3 === void 0
          ? void 0
          : _result$value3.reduce((acc, tuple) => {
              const { key, value } = BidiDeserializer._deserializeTuple(tuple);
              acc[key] = value;
              return acc;
            }, {});
      case "map":
        return (_result$value4 = result.value) === null || _result$value4 === void 0
          ? void 0
          : _result$value4.reduce((acc, tuple) => {
              const { key, value } = BidiDeserializer._deserializeTuple(tuple);
