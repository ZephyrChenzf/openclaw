...
class CRConnection extends _events.EventEmitter {
  ...
  _onClose(reason) {
    ...
    this._browserDisconnectedLogs = _helper.helper.formatBrowserLogs(
...
class CRSession extends _events.EventEmitter {
  ...
  _onMessage(object) {
    ...
    if (object.id && this._callbacks.has(object.id)) {
      ...
      object.id &&
      ((_object$error = object.error) === null || _object$error === void 0
        ? void 0
        : _object$error.code) === -32001
    ) {
      ...
      (0, _utils.assert)(
        ...
        (object === null ||
        object === void 0 ||
        (_object$error2 = object.error) === null ||
        _object$error2 === void 0
          ? void 0
          : _object$error2.message) || undefined,
      );
...
class CDPSession extends _events.EventEmitter {
  constructor(parentSession, sessionId) {
    ...
    this._session = parentSession.createChildSession(sessionId, (method, params) =>
      this.emit(CDPSession.Events.Event, {
        method,
        params,
      }),
    );
    this._listeners = [
      _utils.eventsHelper.addEventListener(parentSession, "Target.detachedFromTarget", (event) => {
