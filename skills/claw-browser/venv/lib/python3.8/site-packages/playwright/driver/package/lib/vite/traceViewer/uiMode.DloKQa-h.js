const __vite__mapDeps = (
  i,
  m = __vite__mapDeps,
  d = m.f || (m.f = ["./assets/xtermModule-BeNbaIVa.js", "./xtermModule.DSXBckUd.css"]),
) => i.map((i) => d[i]);
import {
  u as Me,
  r as V,
...
import { E as Ye, t as Qe, T as Xe, W as Ge } from "./assets/workbench-DIEjrm3Z.js";
var Je = {};
class se {
  constructor(e, t = {}) {
    ((this.isListing = !1),
  ...
  _mergeSuiteInto(e, t) {
    ...
    (s || ((s = new q(e.title, t.type === "project" ? "file" : "describe")), t._addSuite(s)),
  ...
  _mergeTestInto(e, t) {
    let s = this._options.mergeTestCases
      ? t.tests.find((r) => r.title === e.title && r.repeatEachIndex === e.repeatEachIndex)
      : void 0;
    (s ||
      ((s = new Ze(e.testId, e.title, this._absoluteLocation(e.location), e.repeatEachIndex)),
      t._addTest(s),
...
function Z(i) {
  return i.map((e) => (e.s !== void 0 ? e.s : new RegExp(e.r.source, e.r.flags)));
}
function it(i) {
  let e = 0,
    t = 0,
  ...
  for (const r of i.results)
    r.status === "interrupted" ||
      (r.status === "skipped" && i.expectedStatus === "skipped"
        ? ++e
        : r.status === "skipped" || (r.status === i.expectedStatus ? ++t : ++s));
  return t === 0 && s === 0
    ? "skipped"
    : s === 0
      ? "expected"
...
class ie {
      ...
      a = (l) => {
        ...
        return !r.every((n) => _.includes(n)) &&
          ...
          : ((l.children = l.children.filter(
              (n) => !c || (s == null ? void 0 : s.has(n.test.id)) || t.get(n.status),
            )),
  ...
  testIds() {
    const e = new Set(),
      t = (s) => {
        (s.kind === "case" && s.tests.forEach((r) => e.add(r.id)), s.children.forEach(t));
      };
...
function _e(i) {
  ...
  i.kind === "group" &&
    i.children.sort(
      (a, m) => a.location.file.localeCompare(m.location.file) || a.location.line - m.location.line,
    );
...
class ot {
  ...
  _createReporter() {
    return {
          ...
          (this._lastRunReceiver = new se(
            {
              version: () => "v2",
              onBegin: (t) => {
                ((this._lastRunTestCount = t.allTests().length), (this._lastRunReceiver = void 0));
              },
            },
            {
              mergeProjects: !0,
      ...
      onBegin: (e) => {
        var t;
        if ((this.rootSuite || (this.rootSuite = e), this._testResultsSnapshot)) {
          for (const s of this.rootSuite.allTests())
            s.results =
              ((t = this._testResultsSnapshot) == null ? void 0 : t.get(s.id)) || s.results;
  ...
  processTestReportEvent(e) {
    var t, s, r;
    ((s = (t = this._lastRunReceiver) == null ? void 0 : t.dispatch(e)) == null ||
      s.catch(() => {}),
...
const nt = ({ source: i }) => {
    ...
    return (
      ...
      V.useEffect(() => {
        setTimeout(() => {
          a.current &&
            (a.current.fitAddon.fit(), i.resize(a.current.terminal.cols, a.current.terminal.rows));
        }, 250);
      }, [e, i]),
      o.jsx("div", {
        "data-testid": "output",
                        ...
                        children: [
                          o.jsx("input", {
                            ...
                            onClick: () => {
                              ...
                              (x.set(d, !x.get(d)), c(x));
                              const R =
                                (E = a == null ? void 0 : a.config) == null ? void 0 : E.configFile;
                              R &&
                                me.setObject(
                                  R + ":projects",
                                  [...x.entries()].filter(([I, W]) => W).map(([I]) => I),
                                );
                            },
                          }),
        ...
        (b.children.forEach(B),
          !u &&
            ...
            ((b.kind === "test" && c.testIds.has(b.test.id)) ||
              (b.kind === "case" && c.testIds.has((L = b.tests[0]) == null ? void 0 : L.id))) &&
            (u = b));
      };
    ...
    const { selectedTreeItem: D } = h.useMemo(() => {
      ...
      return (
        (u == null ? void 0 : u.kind) === "test"
          ? (b = u.test)
          : (u == null ? void 0 : u.kind) === "case" && u.tests.length === 1 && (b = u.tests[0]),
          ...
          children: [
            o.jsxs("div", {
              ...
              children: [
                ...
                u.kind === "case"
                  ? u.tags.map((B) => o.jsx(dt, { tag: B.slice(1), onClick: (b) => N(b, B) }, B))
                  : null,
              ],
            }),
            !!u.duration &&
              u.status !== "skipped" &&
              o.jsx("div", { className: "ui-mode-list-item-time", children: We(u.duration) }),
            o.jsxs($, {
              noMinHeight: !0,
              noShadow: !0,
              children: [
                ...
                o.jsx(M, {
                  ...
                  onClick: d,
                  style:
                    u.kind === "group" && u.subKind === "folder" ? { visibility: "hidden" } : {},
                }),
                !a &&
                  o.jsx(M, {
                    icon: "eye",
                    title: "Watch",
                    onClick: () => {
                      (m.value.has(u.id) ? m.value.delete(u.id) : m.value.add(u.id), l({ ...m }));
                    },
    ...
    return {
      ...
      source: {
        errors: e.loadErrors
          .filter((t) => {
            var s;
            return ((s = t.location) == null ? void 0 : s.file) === i.location.file;
          })
...
const mt = ({ item: i, rootDir: e, onOpenExternally: t, revealSource: s, pathSeparator: r }) => {
    var f, S;
    ...
    return (
      h.useEffect(() => {
        ...
        const p = d && d.duration >= 0 && d.attachments.find((I) => I.name === "trace");
        if (p && p.path) {
      ...
      o.jsx(
        Ge,
        {
          ...
          annotations: ((S = i.testCase) == null ? void 0 : S.annotations) || [],
          onOpenExternally: t,
          revealSource: s,
        },
        "workbench",
    ...
    children: i.map(({ value: e, set: t, title: s }) =>
      o.jsx(
        "div",
        {
          className: "setting",
          children: o.jsxs("label", {
            children: [o.jsx("input", { type: "checkbox", checked: e, onClick: () => t(!e) }), s],
          }),
        },
        s,
      ),
...
const A = { pending: [], clear: () => {}, write: (i) => A.pending.push(i), resize: () => {} },
  ...
  St = ({}) => {
    ...
    (h.useEffect(() => {
      ...
      h.useEffect(() => {
        ...
        return (
          (A.resize = (g, T) => {
            ((pe = { cols: g, rows: T }), v.resizeTerminalNoReply({ cols: g, rows: T }));
          }),
          () => {
...
`,
      ...
      h.useEffect(() => {
        ...
        const { config: w, rootSuite: g } = n,
          T = w.configFile ? me.getObject(w.configFile + ":projects", void 0) : void 0,
          j = new Map(l);
        for (const C of j.keys()) g.suites.find((F) => F.title === C) || j.delete(C);
        for (const C of g.suites)
          j.has(C.title) || j.set(C.title, !!(T != null && T.includes(C.title)));
        (!T && j.size && ![...j.values()].includes(!0) && j.set(j.entries().next().value[0], !0),
          (l.size !== j.size || [...l].some(([C, F]) => j.get(C) !== F)) && _(j));
      }, [l, n]),
      h.useEffect(() => {
        N && n != null && n.progress ? d(n.progress) : n || d(void 0);
      }, [n, N]));
    const { testTree: Ce } = h.useMemo(() => {
        if (!n) return { testTree: new ie("", new q("", "root"), [], l, y.pathSeparator) };
        ...
        (w, g) => {
          !v ||
            ...
            (H.current = H.current.then(async () => {
              ...
              {
                for (const k of ((C = n.rootSuite) == null ? void 0 : C.allTests()) || [])
                  if (T.has(k.id)) {
                    k.results = [];
              ...
              (A.write("\x1B[2m—".repeat(Math.max(0, pe.cols - j.length)) + j + "\x1B[22m"),
              ...
              for (const k of ((F = n.rootSuite) == null ? void 0 : F.allTests()) || [])
                ((P = k.results[0]) == null ? void 0 : P.duration) === -1 && (k.results = []);
        ...
        if (u) {
          const P = (k) => {
            ...
            (U && F.has(U) && C.push(...j.collectTestIds(k)),
              k.kind === "group" && k.subKind === "folder" && k.children.forEach(P));
          };
          P(j.rootItem);
        } else
    ...
    const ee = h.useRef(null),
      Ne = h.useCallback((w) => {
        var g;
        (w.preventDefault(), w.stopPropagation(), (g = ee.current) == null || g.showModal());
      }, []),
      te = h.useCallback((w) => {
        var g;
        (w.preventDefault(), w.stopPropagation(), (g = ee.current) == null || g.close());
      }, []),
      Pe = h.useCallback(
        (w) => {
          (te(w),
            ...
            children: [
              ...
              o.jsxs("div", {
                ...
                children: [
                  ...
                  o.jsx("br", {}),
                  o.jsx("button", { className: "button", onClick: Pe, children: "Install" }),
                  o.jsx("button", {
            ...
            children: [
                ...
                children: [
                  o.jsxs($, {
                    children: [
                      ...
                      o.jsx(M, { icon: "close", title: "Close", onClick: () => s(!1) }),
                    ],
                  }),
                  o.jsx(nt, { source: A }),
                ],
              ...
              o.jsx("div", {
                ...
                children: o.jsx(mt, {
                  pathSeparator: y.pathSeparator,
                  item: p,
                  rootDir: (he = n == null ? void 0 : n.config) == null ? void 0 : he.rootDir,
                  revealSource: je,
                  onOpenExternally: (w) =>
                    v == null
                      ? void 0
                      : v.openNoReply({
                          location: { file: w.file, line: w.line, column: w.column },
                        }),
                }),
              }),
            ],
          ...
          sidebar: o.jsxs("div", {
            ...
            children: [
              ...
              o.jsxs($, {
                noMinHeight: !0,
                children: [
                  !N && !S && o.jsx("div", { className: "section-title", children: "Tests" }),
                  !N &&
                    S &&
                    o.jsx("div", {
              ...
              G && o.jsx(wt, { settings: [{ value: Ie, set: Re, title: "Dark mode" }] }),
            ],
          }),
        }),
      ],
