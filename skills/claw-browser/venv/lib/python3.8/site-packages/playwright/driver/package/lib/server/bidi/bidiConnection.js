  ...
  _dispatchMessage(message) {
    ...
    if (object.type === "event") {
      ...
      if ("context" in object.params) context = object.params.context;
        ...
        context =
          (_object$params$source = object.params.source) === null ||
          _object$params$source === void 0
            ? void 0
            : _object$params$source.context;
      if (context) {
    ...
    if (object.id && this._callbacks.has(object.id)) {
      ...
      if (object.type === "error") {
        ...
        callback.error.setMessage(
          "Internal error, unexpected response type: " + JSON.stringify(object),
        );
        callback.reject(callback.error);
      }
    } else if (object.id) {
