...
import { W as M } from "./assets/workbench-DIEjrm3Z.js";
function S(t, e) {
  t && window.parent.postMessage({ method: "openExternal", params: { url: t, target: e } }, "*");
}
...
const L = () => {
    ...
    return (
      r.useEffect(() => {
        (window.addEventListener("message", async ({ data: { method: s, params: n } }) => {
      ...
      r.useEffect(() => {
        (async () => {
          if (t.length) {
            ...
            (navigator.serviceWorker.addEventListener("message", s), d({ done: 0, total: 1 }));
            const n = [];
      ...
      r.useEffect(() => {
        ...
        l &&
          ((s = window.parent) == null ||
            s.postMessage({ method: "showErrorMessage", params: { message: l } }, "*"));
      }, [l]),
      o.jsxs("div", {
        ...
        children: [
          ...
          o.jsx(M, { model: a, openPage: S, onOpenExternally: j, showSettings: !0 }),
          !t.length &&
            o.jsx("div", {
