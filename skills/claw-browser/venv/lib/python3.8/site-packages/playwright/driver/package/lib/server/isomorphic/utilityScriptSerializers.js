...
function source() {
  ...
  function isError(obj) {
    try {
      ...
      return (
        ...
        (obj &&
          ((_Object$getPrototypeO = Object.getPrototypeOf(obj)) === null ||
          _Object$getPrototypeO === void 0
            ? void 0
            : _Object$getPrototypeO.name) === "Error")
      );
    } catch (error) {
      return false;
    }
  ...
  function parseEvaluationResultValue(value, handles = [], refs = new Map()) {
    ...
    if (typeof value === "object" && value) {
      ...
      if ("o" in value) {
        const result = {};
        refs.set(value.id, result);
        for (const { k, v } of value.o) result[k] = parseEvaluationResultValue(v, handles, refs);
        return result;
      }
  ...
  function innerSerialize(value, handleSerializer, visitorInfo) {
    ...
    if (isError(value)) {
      ...
      let stack;
      if (
        (_value$stack = value.stack) !== null &&
        _value$stack !== void 0 &&
        _value$stack.startsWith(value.name + ": " + value.message)
      ) {
        // v8
        stack = value.stack;
      } else {
...
const result = source();
const parseEvaluationResultValue = (exports.parseEvaluationResultValue =
  result.parseEvaluationResultValue);
