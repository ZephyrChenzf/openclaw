      ...
      if (overlap_length1 >= overlap_length2) {
        if (overlap_length1 >= deletion.length / 2 || overlap_length1 >= insertion.length / 2) {
          ...
          diffs.splice(
            pointer,
            0,
            new diff_match_patch.Diff(DIFF_EQUAL, insertion.substring(0, overlap_length1)),
          );
        ...
        if (overlap_length2 >= deletion.length / 2 || overlap_length2 >= insertion.length / 2) {
          ...
          diffs.splice(
            pointer,
            0,
            new diff_match_patch.Diff(DIFF_EQUAL, deletion.substring(0, overlap_length2)),
          );
            ...
            if (commonlength !== 0) {
              if (
                ...
                diffs.splice(
                  0,
                  0,
                  new diff_match_patch.Diff(DIFF_EQUAL, text_insert.substring(0, commonlength)),
                );
                pointer++;
              }
        ...
        if (
          ...
          for (var y = 0; y < patches[x].diffs.length; y++) {
            ...
            if (mod[0] === DIFF_INSERT) {
              // Insertion
              text =
                text.substring(0, start_loc + index2) + mod[1] + text.substring(start_loc + index2);
