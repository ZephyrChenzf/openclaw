...
class BrowserContext extends _channelOwner.ChannelOwner {
  ...
  constructor(parent, type, guid, initializer) {
    ...
    (_this$_browser = this._browser) === null ||
      _this$_browser === void 0 ||
      _this$_browser._contexts.add(this);
    this._isChromium =
      ((_this$_browser2 = this._browser) === null || _this$_browser2 === void 0
        ? void 0
        : _this$_browser2._name) === "chromium";
    ...
    this._channel.on("pageError", ({ error, page }) => {
      ...
      this.emit(
        _events.Events.BrowserContext.WebError,
        new _webError.WebError(pageObject, parsedError),
      );
    ...
    this._setEventToSubscriptionMapping(
      new Map([
        [_events.Events.BrowserContext.Console, "console"],
        [_events.Events.BrowserContext.Dialog, "dialog"],
        [_events.Events.BrowserContext.Request, "request"],
        [_events.Events.BrowserContext.Response, "response"],
        [_events.Events.BrowserContext.RequestFinished, "requestFinished"],
        [_events.Events.BrowserContext.RequestFailed, "requestFailed"],
      ]),
    );
  }
  ...
  async _onRoute(route) {
    ...
    for (const routeHandler of routeHandlers) {
      ...
      if ((page !== null && page !== void 0 && page._closeWasCalled) || this._closeWasCalled)
        return;
  ...
  async _recordIntoHAR(har, page, options = {}) {
    ...
    const { harId } = await this._channel.harStart({
      ...
      options: prepareRecordHarOptions({
        path: har,
        content:
          (_options$updateConten = options.updateContent) !== null &&
          _options$updateConten !== void 0
            ? _options$updateConten
            : "attach",
        mode:
          (_options$updateMode = options.updateMode) !== null && _options$updateMode !== void 0
            ? _options$updateMode
            : "minimal",
    ...
    this._harRecorders.set(harId, {
      path: har,
      content:
        (_options$updateConten2 = options.updateContent) !== null &&
        _options$updateConten2 !== void 0
          ? _options$updateConten2
          : "attach",
    });
  }
  ...
  async unrouteAll(options) {
    await this._unrouteInternal(
      this._routes,
      [],
      options === null || options === void 0 ? void 0 : options.behavior,
    );
  ...
  _effectiveCloseReason() {
    ...
    return (
      this._closeReason ||
      ((_this$_browser3 = this._browser) === null || _this$_browser3 === void 0
        ? void 0
        : _this$_browser3._closeReason)
    );
  }
    ...
    return await this._wrapApiCall(async () => {
      ...
      if (event !== _events.Events.BrowserContext.Close)
        waiter.rejectOnEvent(
          ...
          () => new _errors.TargetClosedError(this._effectiveCloseReason()),
        );
  ...
  _onClose() {
    ...
    (_this$_browserType = this._browserType) === null ||
      ...
      (_this$_browserType = _this$_browserType._contexts) === null ||
      _this$_browserType === void 0 ||
      _this$_browserType.delete(this);
    this._disposeHarRouters();
  ...
  async close(options = {}) {
    ...
    await this._wrapApiCall(async () => {
      ...
      await ((_this$_browserType2 = this._browserType) === null || _this$_browserType2 === void 0
        ? void 0
        : _this$_browserType2._willCloseContext(this));
...
async function prepareBrowserContextParams(options) {
  ...
  if (contextParams.recordVideo && contextParams.recordVideo.dir)
    contextParams.recordVideo.dir = _path.default.resolve(
      process.cwd(),
