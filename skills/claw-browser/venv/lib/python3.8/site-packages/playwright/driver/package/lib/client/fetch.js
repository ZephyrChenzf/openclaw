  ...
  async newContext(options = {}) {
    ...
    const storageState =
      typeof options.storageState === "string"
        ? JSON.parse(await _fs.default.promises.readFile(options.storageState, "utf8"))
        : options.storageState;
    // We do not expose tracesDir in the API, so do not allow options to accidentally override it.
    const tracesDir =
      (_this$_defaultContext = this._defaultContextOptions) === null ||
      _this$_defaultContext === void 0
        ? void 0
        : _this$_defaultContext.tracesDir;
    const context = APIRequestContext.from(
      (
        await this._playwright._channel.newRequest({
          ...
          storageState,
          tracesDir,
          clientCertificates: await (0, _browserContext.toClientCertificatesProtocol)(
...
class APIRequestContext extends _channelOwner.ChannelOwner {
  ...
  async dispose(options = {}) {
    ...
    (_this$_request = this._request) === null ||
      _this$_request === void 0 ||
      _this$_request._contexts.delete(this);
  }
  ...
  async _innerFetch(options = {}) {
    return await this._wrapApiCall(async () => {
      ...
      const method =
        options.method ||
        ((_options$request = options.request) === null || _options$request === void 0
          ? void 0
          : _options$request.method());
      ...
      const headersObj =
        options.headers ||
        ((_options$request2 = options.request) === null || _options$request2 === void 0
          ? void 0
          : _options$request2.headers());
      ...
      if (
        ...
        postDataBuffer =
          ((_options$request3 = options.request) === null || _options$request3 === void 0
            ? void 0
            : _options$request3.postDataBuffer()) || undefined;
      const fixtures = {
...
class APIResponse {
  ...
  async _fetchLog() {
    const { log } = await this._request._channel.fetchLog({
      fetchUid: this._fetchUid(),
    });
    return log;
  }
