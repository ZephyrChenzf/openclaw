...
class Recorder {
  ...
  async _install(recorderApp) {
    ...
    this._context.once(_browserContext.BrowserContext.Events.Close, () => {
      ...
      (_this$_recorderApp = this._recorderApp) === null ||
        ...
        _this$_recorderApp.close().catch(() => {});
    });
    ...
    await this._context.exposeBinding("__pw_recorderState", false, (source) => {
      let actionSelector = "";
      let actionPoint;
      const hasActiveScreenshotCommand = [...this._currentCallsMetadata.keys()].some(
        isScreenshotCommand,
      );
    ...
    await this._context.exposeBinding(
      ...
      async ({ frame }, selector) => {
        ...
        await ((_this$_recorderApp2 = this._recorderApp) === null || _this$_recorderApp2 === void 0
          ? void 0
          : _this$_recorderApp2.setSelector(
              (0, _recorderUtils2.buildFullSelector)(selectorChain, selector),
              true,
            ));
      },
    );
  ...
  _pausedStateChanged() {
    ...
    (_this$_recorderApp3 = this._recorderApp) === null ||
      _this$_recorderApp3 === void 0 ||
      _this$_recorderApp3.setPaused(this._debugger.isPaused());
  ...
  setMode(mode) {
    ...
    (_this$_recorderApp4 = this._recorderApp) === null ||
      ...
      _this$_recorderApp4.setMode(this._mode);
    this._contextRecorder.setEnabled(
      this._mode === "recording" ||
        this._mode === "assertingText" ||
        this._mode === "assertingVisibility" ||
        this._mode === "assertingValue",
    );
    this._debugger.setMuted(
      this._mode === "recording" ||
        this._mode === "assertingText" ||
        this._mode === "assertingVisibility" ||
        this._mode === "assertingValue",
  ...
  setHighlightedSelector(language, selector) {
    this._highlightedSelector = (0, _locatorParser.locatorOrSelectorAsSelector)(
      language,
      selector,
  ...
  _refreshOverlay() {
    for (const page of this._context.pages())
      page
        .mainFrame()
        .evaluateExpression("window.__pw_refreshOverlay()")
        .catch(() => {});
  }
  async onBeforeCall(sdkObject, metadata) {
    if (
      this._omitCallTracking ||
      this._mode === "recording" ||
      this._mode === "assertingText" ||
      this._mode === "assertingVisibility" ||
      this._mode === "assertingValue"
    ...
    if (isScreenshotCommand(metadata)) {
      ...
      (_this$_recorderApp5 = this._recorderApp) === null ||
        ...
        _this$_recorderApp5.setSelector(this._highlightedSelector).catch(() => {});
    }
  }
  ...
  _updateUserSources() {
    ...
    if (fileToSelect)
      (_this$_recorderApp6 = this._recorderApp) === null ||
        ...
        _this$_recorderApp6.setRunningFile(fileToSelect);
  }
  _pushAllSources() {
    var _this$_recorderApp7;
    (_this$_recorderApp7 = this._recorderApp) === null ||
      _this$_recorderApp7 === void 0 ||
      _this$_recorderApp7.setSources([...this._recorderSources, ...this._userSources.values()]);
  }
  ...
  updateCallLog(metadatas) {
    ...
    (_this$_recorderApp8 = this._recorderApp) === null ||
      ...
      _this$_recorderApp8.updateCallLogs(logs);
  }
