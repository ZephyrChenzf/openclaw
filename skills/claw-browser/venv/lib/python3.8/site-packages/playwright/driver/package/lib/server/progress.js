...
class ProgressController {
  ...
  async run(task, timeout) {
    ...
    this._state = "running";
    (_this$sdkObject$attri = this.sdkObject.attribution.context) === null ||
      _this$sdkObject$attri === void 0 ||
      _this$sdkObject$attri._activeProgressControllers.add(this);
    const progress = {
      log: (message) => {
      ...
      timeUntilDeadline: () =>
        this._deadline ? this._deadline - (0, _utils.monotonicTime)() : 2147483647,
    ...
    try {
      ...
      (_this$sdkObject$attri2 = this.sdkObject.attribution.context) === null ||
        _this$sdkObject$attri2 === void 0 ||
        _this$sdkObject$attri2._activeProgressControllers.delete(this);
      clearTimeout(timer);
    }
  }
}
