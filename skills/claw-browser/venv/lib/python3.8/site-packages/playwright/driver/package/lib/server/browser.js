...
class Browser extends _instrumentation.SdkObject {
  ...
  async newContext(metadata, options) {
    ...
    try {
      ...
      await ((_clientCertificatesPr = clientCertificatesProxy) === null ||
      _clientCertificatesPr === void 0
        ? void 0
        : _clientCertificatesPr.close());
      throw error;
    }
  ...
  async newContextForReuse(params, metadata) {
    ...
    if (
      ...
      hash !== this._contextForReuse.hash ||
      !this._contextForReuse.context.canResetForReuse()
    ) {
  ...
  async stopPendingOperations(reason) {
    ...
    await ((_this$_contextForReus = this._contextForReuse) === null ||
    _this$_contextForReus === void 0 ||
    (_this$_contextForReus = _this$_contextForReus.context) === null ||
    _this$_contextForReus === void 0
      ? void 0
      : _this$_contextForReus.stopPendingOperations(reason));
  }
