  ...
  constructor(options) {
    ...
    if (options.preLaunchedAndroidDevice)
      this._preLaunchedPlaywright =
        options.preLaunchedAndroidDevice._android.attribution.playwright;
    ...
    this._wsServer = new _wsServer.WSServer({
      onUpgrade: (request, socket) => {
        const uaError = (0, _utils.userAgentVersionMatchesErrorMessage)(
      ...
      onConnection: (request, url, ws, id) => {
        ...
        return new _playwrightConnection.PlaywrightConnection(
          semaphore.acquire(),
          clientType,
          ws,
          {
      ...
      onClose: async () => {
        ...
        if (this._preLaunchedPlaywright)
          await Promise.all(
            this._preLaunchedPlaywright.allBrowsers().map((browser) =>
              browser.close({
