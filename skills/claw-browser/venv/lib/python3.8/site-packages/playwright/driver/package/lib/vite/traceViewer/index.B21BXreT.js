...
import { W as F } from "./assets/workbench-DIEjrm3Z.js";
const I = () => {
    ...
    o.useEffect(() => {
      const t = async (r) => {
        ...
        if ((a = r.clipboardData) != null && a.files.length) {
          for (const s of r.clipboardData.files) if (s.type !== "application/zip") return;
          (r.preventDefault(), h(r.clipboardData.files));
        }
      };
      return (
        document.addEventListener("paste", t), () => document.removeEventListener("paste", t)
      );
    });
    ...
    return e.jsxs("div", {
      ...
      children: [
        ...
        e.jsx(F, { model: f, inert: j, showSettings: !0 }),
        x &&
          e.jsxs("div", {
